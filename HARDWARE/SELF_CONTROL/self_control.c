...
{int out=1;
    ...
    {   int ix;
        ...
        case 0:
            ...
            break;
        case 1:
            speed_up_CNT_us(4,303,1,20);//正旋
            if(iq==2||iq==3) is++;
            if(is==5) out=0;
            iq=1;
            break;
        case 2:
            speed_up_CNT_us(5,303,1,20);//逆旋
            if(iq==1||iq==4) is++;
            if(is==5) out=0;
            iq=2;
            break;
        ...
        case 5:LEFT=SortAndCal(2,5);
            ...
            speed_up_CNT_us(3,303,2,B_step);//右移
            step_wait();
            break;
        case 6:RIGHT=SortAndCal(3,5);
            ...
            speed_up_CNT_us(2,303,2,B_step);//左移
            step_wait();
            break;
         case 7:
            speed_up_CNT_us(4,303,1,160);//正旋
            break;
         case 8:
            speed_up_CNT_us(5,303,1,160);//逆旋
            break;
       default : 
            out=0;
            break;           
